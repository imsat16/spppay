...
class KelasXPage extends StatefulWidget {
  @override
  _KelasXPageState createState() => _KelasXPageState();
}

class _KelasXPageState extends State<KelasXPage> {
  List _dataSiswa = List();
  String kelasX = "X";
  void getData() async {
    Uri url = Uri.parse("https://spppay1.000webhostapp.com/getDataSiswa.php");
    var response = await http.post(url, body: {"nama_kelas": kelasX});
    setState(() {
