...
class KelasXIPage extends StatefulWidget {
  @override
  _KelasXIPageState createState() => _KelasXIPageState();
}

class _KelasXIPageState extends State<KelasXIPage> {
  List _dataSiswa = List();
  String kelasXI = "XI";
  void getData() async {
    Uri url = Uri.parse("https://spppay1.000webhostapp.com//getDataSiswa.php");
    final response = await http.post(url, body: {"nama_kelas": kelasXI});
    setState(() {
