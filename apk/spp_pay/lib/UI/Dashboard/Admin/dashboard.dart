...
class _DashboardAdminPageState extends State<DashboardAdminPage> {
  ...
  Widget build(BuildContext context) {
    var data = [
      ClickPerMonth('Jan', 30, Colors.red),
      ClickPerMonth('Feb', 42, Colors.yellow),
      ClickPerMonth('Mar', 54, Colors.yellow),
      ClickPerMonth('Apr', 20, Colors.red),
      ClickPerMonth('May', 80, Colors.green[400]),
      ClickPerMonth('Jun', 35, Colors.red),
      ClickPerMonth('Jul', 35, Colors.red),
      ClickPerMonth('Agt', 35, Colors.red),
    ];
