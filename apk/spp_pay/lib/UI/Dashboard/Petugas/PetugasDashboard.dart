...
class DashboardPetugasPage extends StatefulWidget {
  @override
  _DashboardPetugasPageState createState() => _DashboardPetugasPageState();
}
...
class _DashboardPetugasPageState extends State<DashboardPetugasPage> {
  ...
  Widget build(BuildContext context) {
    var data = [
      ...
      ClickPerMonth('Jul', 35, Colors.purple),
      ClickPerMonth('Agt', 35, Colors.blue),
      ClickPerMonth('Sep', 35, Colors.purple),
      ClickPerMonth('Okt', 35, Colors.blue),
      ClickPerMonth('Nov', 5, Colors.purple),
    ];
